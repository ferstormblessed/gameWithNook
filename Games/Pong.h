...
namespace Pong {
    ...
    void updateBall(const NOOK::Entity entity) {
        ...
        float xMagnitude = float(direction) * NOOK::randomFloat(10.0f, 15.0f);
        float yMagnitude = float(direction) * NOOK::randomFloat(10.0f, 15.0f);
    ...
    void initBall() {
        ...
        rb.initSpeed = b2Vec2{float(NOOK::randomSign()) * NOOK::randomFloat(10.0f, 15.0f), NOOK::randomSign() * NOOK::randomFloat(10.0f, 15.f)};
